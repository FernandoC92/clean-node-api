import { InvalidParamError, MissinParamError, ServerError } from '../errors/index'
...
const makeSut = (): SutTypes => {
  // ? stub: "dublê de testes", pega uma função e dar um retorno "marretado para ela"
...
describe('SignUp Controller', () => {
  ...
  test('should return 500 if email EmailValidator throws', () => {
